...
const NetworksSelectBoxIn: React.FC<Omit<Appstate, "tokenAmount"> & extendprops> = ({
  ...
  return (
    <div>
      <p>Assets from</p>
      <div
        className="px-4 py-3 cursor-pointer rounded-2xl bg-primary/40"
      ...
      >
        <div className="w-full dropdown dropdown-bottom">
          ...
          {dropdownVisible && (
            <ul
              tabIndex={0}
              className="dropdown-content gap-4 p-3 z-[1] menu p-2 shadow bg-base-100 rounded-box w-full"
            >
